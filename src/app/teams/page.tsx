...
export default function TeamsPage() {
  ...
  const handleAddTeam = (event: React.FormEvent) => {
    ...
    addTeam({ id: `team-${Date.now()}`, name: name.trim(), shortName: shortName.trim().toUpperCase(), owner: owner.trim(), ownerPhotoUrl: ownerPhotoUrl.trim() || undefined, logoUrl: logoUrl.trim() || undefined, color, startingPurse: 1500, spentPurse: 0 });
